...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.IncomeService.getMonthlyIncome().subscribe((income) => {
      ...
      this.updateBarChartData();
      console.log(
        'ngOnInit - barChartData after income update:',
        this.barChartData
      );
    });
    ...
    this.ExpenseService.getMonthlyExpense().subscribe((expense) => {
      ...
      this.updateBarChartData();
      console.log(
        'ngOnInit - barChartData after expense update:',
        this.barChartData
      );
    });
  ...
  updateBarChartLabels(): void {
    console.log(
      'updateBarChartLabels - currentMonthName:',
      this.currentMonthName
    );
    console.log(
      'updateBarChartLabels - initial barChartData:',
      this.barChartData
    );
    if (
      this.barChartData &&
      ...
      console.log(
        'updateBarChartLabels - currentMonthIndex:',
        currentMonthIndex
      );
      if (currentMonthIndex === -1) {
        this.barChartData.labels.push(this.currentMonthName);
        console.log(
          'updateBarChartLabels - labels after push:',
          this.barChartData.labels
        );
        if (this.barChartData.labels.length > 3) {
          ...
          if (
            ...
            console.log(
              'updateBarChartLabels - income data after shift:',
              this.barChartData.datasets[0].data
            );
          }
          if (
            ...
            console.log(
              'updateBarChartLabels - expense data after shift:',
              this.barChartData.datasets[1].data
            );
          }
        } else {
          if (
            ...
            console.log(
              'updateBarChartLabels - income data after push 0:',
              this.barChartData.datasets[0].data
            );
          }
          if (
            ...
            console.log(
              'updateBarChartLabels - expense data after push 0:',
              this.barChartData.datasets[1].data
            );
          }
        }
    ...
    console.log(
      'updateBarChartLabels - final barChartData:',
      this.barChartData
    );
  }
  ...
  async updateBarChartData(): Promise<void> {
    console.log(
      'updateBarChartData - currentMonthName:',
      this.currentMonthName
    );
    console.log(
      'updateBarChartData - initial barChartData:',
      this.barChartData
    );
    if (
      this.barChartData &&
      ...
      if (incomeDataset?.data && currentMonthIndex !== -1) {
        ...
        console.log(
          'updateBarChartData - income data updated:',
          incomeDataset.data
        );
      }
      ...
      if (expenseDataset?.data && currentMonthIndex !== -1) {
        ...
        console.log(
          'updateBarChartData - expense data updated:',
          expenseDataset.data
        );
      }
    }
